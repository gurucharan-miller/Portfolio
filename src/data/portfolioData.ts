import { Skill, Project, ExperienceItem, EducationItem, CertificateItem, GithubStat, PersonalInfo, PortfolioData } from '../types/portfolio';
...
export const GITHUB_STATS_DATA: GithubStat = {
  totalCommits: 520,
  pullRequests: 42,
  starsEarned: 135,
